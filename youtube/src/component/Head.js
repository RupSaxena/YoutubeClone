...
<div className="font-bold text-white-200 flex justify-between w-12/12 p-1 m-1 shadow-lg">
 ...
 <img onClick={()=>handlemenu()}className="cursor-pointer"alt="icon" src="https://cdn.iconscout.com/icon/free/png-256/free-hamburger-menu-462145.png?f=webp"width="70px" />
...
<div className="col-span-1"><img className="h-13 cu"alt="user"src="https://www.iconpacks.net/icons/2/free-user-icon-3296-thumb.png" width="50px"/></div>
</div>
);
}
export default Head;